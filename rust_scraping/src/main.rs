...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let req = ChatCompletionRequest::new(
        ...
        vec![chat_completion::ChatCompletionMessage {
            ...
            content: chat_completion::Content::Text(
                String::from(
                    "Can you give me the industry (string), responsibilities (array of strings), and qualifications (array of strings) of this job listing in valid JSON. Find as many responsibilities and qualifications as it says: Multiplatform Editor, Newsletters (Temporary)
  ...
  Apply Now?"
    ...
    // remove ```josn ``` from the start and end of the string
